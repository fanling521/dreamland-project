create schema dreamland_auth;
create schema dreamland_order;
create schema dreamland_attachment;
create schema dreamland_gateway;
create schema dreamland_eureka;
