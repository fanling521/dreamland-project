...
import com.fanling.dreamland.common.util.Threads;
 ...
 */
@Component
public class SessionValidSch implements SessionValidationScheduler
{
    private static final Logger log = LoggerFactory.getLogger(SessionValidSch.class);
