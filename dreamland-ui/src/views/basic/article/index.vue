<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input clearable style="width: 280px" class="filter-item" v-model="search.title" placeholder="请输入标题" @keyup.enter.native="onSearch"></el-input>
    ...
    <add-article :addVisible.sync="addVisible" v-if="addVisible" @callback="initTable"/>
    <edit-article :id="id" :editVisible.sync="editVisible" v-if="editVisible" @callback="initTable"/>
  </div>
</template>
<script>
