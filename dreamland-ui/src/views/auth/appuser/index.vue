<template>
  <div class="app-container">
    ...
    <el-table :header-cell-style="{background:'#F5F7FA'}" :data="list" tooltip-effect="light" style="width: 100%">
      ...
      <el-table-column header-align="center" align="center" prop="role_key" label="角色标识"></el-table-column>
      ...
      <el-table-column header-align="center" align="center" prop="sex" label="性别"></el-table-column>
