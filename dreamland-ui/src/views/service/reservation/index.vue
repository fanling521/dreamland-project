      ...
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="小区室号">
              <span>{{ props.row.room_info }}</span>
            </el-form-item>
            ...
            <el-form-item label="预约标记">
              <span>{{ props.row.reservation_type }}</span>
            </el-form-item>
          </el-form>
        </template>
      </el-table-column>
      <el-table-column align="center" header-align="center" type="index" width="50" label="序号"></el-table-column>
      <el-table-column header-align="center" align="center" prop="position" label="坐标位置"></el-table-column>
      <el-table-column header-align="center" align="center" prop="room_info" label="小区室号"></el-table-column>
      <el-table-column header-align="center" align="center" prop="area" label="省市区街道"></el-table-column>
      <el-table-column header-align="center" align="center" prop="community_name" label="小区名称"></el-table-column>
      <el-table-column header-align="center" align="center" prop="price" label="服务费用"></el-table-column>
      <el-table-column header-align="center" align="center" prop="reservation_type" label="预约标记"></el-table-column>
...
<script>
    import {list, remove} from '@/api/reservation'
